...
> **Licensing.** Harbor is licensed under the Apache License, Version 2.0. The
> vendored models below and the ported adapters are derivative works of it. The
> change statements required by Apache-2.0 section 4(b) are recorded in this file
> and summarised in the repository's `NOTICE`; the licence itself is in `LICENSE`.
